<template>
  <section id="traits" class="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-24 mb-16">
    <div class="mb-12">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
      <div class="flex justify-center lg:justify-start">
        <div class="w-full max-w-sm bg-transparent">
          <svg viewBox="0 0 1024 1024" class="w-full h-auto overflow-visible">
            <defs>
              <path
                id="orbit1"
      ...
      <div class="flex flex-col gap-8">
        <div>
          <h3
            class="text-[10px] font-black uppercase tracking-[0.25em] text-gray-400 mb-8 flex items-center"
          >
            <span class="mr-4">Professional DNA</span>
          ...
          <div class="flex flex-wrap gap-3">
            <div
              ...
              :key="trait"
              class="group flex items-center px-5 py-2.5 bg-white border border-gray-100 rounded-full hover:border-black hover:shadow-sm transition-all duration-300 cursor-default"
            >
              <div
                class="w-1.5 h-1.5 rounded-full bg-gray-300 group-hover:bg-black mr-3 transition-colors"
              ></div>
              <span
                class="text-[11px] font-black uppercase tracking-widest text-gray-500 group-hover:text-black transition-colors"
              >
                {{ trait }}
              </span>
            </div>
        ...
        <div class="relative pl-6 py-2 border-l-2 border-gray-100">
          <p class="text-sm text-gray-500 leading-relaxed font-medium italic">
            "I approach development with a focus on clean architecture, proactive communication, and
            a relentless drive for pixel-perfect results."
          </p>
        </div>
      </div>
    </div>
